...
CREATE TABLE `transacciones` (
  ...
  KEY `FK1a33h3l8vuq04gv508f9gfpoa` (`id_accion`),
  CONSTRAINT `FK1a33h3l8vuq04gv508f9gfpoa` FOREIGN KEY (`id_accion`) REFERENCES `acciones_compradas` (`id_compra`),
  CONSTRAINT `transacciones_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`),
  CONSTRAINT `transacciones_ibfk_2` FOREIGN KEY (`id_accion`) REFERENCES `acciones_disponibles` (`id_accion`)
